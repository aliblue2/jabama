...
const Navbar = () => {
  return (
    <div className="relative grid grid-cols-4 gap-5 py-4 bg-white md:shadow-md md:rounded-lg lg:px-20 mt-72 md:grid-cols-8">
      <div className="flex flex-col items-center justify-center">
        <Image src={villaImg} alt="villa-image" className="max-w-14" />
        <h6 className="text-sm font-medim">ویلا</h6>
      </div>
      <div className="flex flex-col items-center justify-center">
        <Image src={kolbehImg} alt="kolbeh-image" className="max-w-14" />
        <h6 className="text-sm font-medim"> کلبه </h6>
      </div>
      <div className="flex flex-col items-center justify-center">
        <Image src={boomImg} alt="boom-image" className="max-w-14" />
        <h6 className="text-sm font-medim"> بومگردی </h6>
      </div>
      <div className="flex flex-col items-center justify-center">
        <Image src={poolImg} alt="pool-image" className="max-w-14" />
        <h6 className="text-sm font-medim"> استخردار </h6>
      </div>
      <div className="flex flex-col items-center justify-center">
        <Image src={beachImg} alt="beach-image" className="max-w-14" />
        <h6 className="text-sm font-medim"> ساحلی </h6>
      </div>
      <div className="flex flex-col items-center justify-center">
        <Image src={buildingImg} alt="building-image" className="max-w-14" />
        <h6 className="text-sm font-medim"> آپارتمان </h6>
      </div>
      <div className="flex flex-col items-center justify-center">
        <Image src={offerImg} alt="offer-image" className="max-w-14" />
